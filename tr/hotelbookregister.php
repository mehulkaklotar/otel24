...
if(isset($_POST['signup']))
{
	...
	else
	{
		...
		else
		{
			...
			$msg="Hello,<br>Your Username is '".$_POST['txtuname']."' and Password is '".$_POST['txtpass']."'. <br> Click Here to <a href='http://www.otel24.com.tr/tr/activate.php?id=".$_POST['txtuname']."'>Activate</a> your Account.<br><br>Regards,<br>OTEL24";
			$to=$_POST['txtemail'];
