...
$id="";
$hotel1_sql="select id from tbl_hotel where hotel_name_Turkish like '%".$search."%'";
...
$country_sql="select h.id as hotel_id,c.country_Turkish from tbl_hotel h ,country c where h.country=c.country_id and country_Turkish like '%".$search."%'";
...
$state_sql="select h.id as hotel_id,s.name_Turkish from tbl_hotel h ,state s where h.state=s.id and name_Turkish like '%".$search."%'";
...
$city_sql="select h.id as hotel_id,ci.city_Turkish from tbl_hotel h ,city ci where h.city=ci.id and city_Turkish like '%".$search."%'";
...
$local_sql="select h.id as hotel_id,l.local_Turkish from tbl_hotel h ,local l where h.local=l.id and local_Turkish like '%".$search."%'";
...
$village_sql="select h.id as hotel_id,v.village_Turkish from tbl_hotel h ,village v where h.village=v.id and village_Turkish like '%".$search."%'";
...
$zipcode_sql="select h.id as hotel_id,z.zipcode_Turkish from tbl_hotel h ,tbl_zip z where h.zipcode=z.zipcode_id and zipcode_Turkish like '%".$search."%'";
...
<div id="sort1" class="floatleft">
        <a href="searchres.php?by=prices_Turkish">PRICE</a>|<br />

        <a href="searchres.php?by=rooms">ROOMS</a><br />

        <a href="searchres.php?by=rate">RATE</a><br />

        <a href="searchres.php?by=hotel_name_Turkish">NAMES</a><br />

        <a href="searchres.php?by=city">CITY</a><br />
...
if(isset($_REQUEST['by']) && $_REQUEST['by']=="rooms")
{
    ...
    <div id="middlehotel" class="floatleft">
        <div id="hotelname">
            <?php echo $row['hotel_name_Turkish'];?>
        </div>
        <div id="hotelcontent">
            <?php
    ...
    <div class="clear" ></div>   
		...
		<div class="image2 floatleft">
            ...
            <tr>
            	<td class="avalvalue" nowrap="nowrap" align="left">Last (<font color="#FF0000"><font color="#FF0000">
            	  <?php 
				$room=0;
