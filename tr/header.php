                            ...
                            <td align="right" class="headlink" valign="top">
                                    <table cellspacing="0" cellpadding="0" border="0">
                                      <tr>
										...
										echo "Merhaba, <b>".$user_res['user_id']."</b><font size='3' color='grey'> |&nbsp;</font>";
										}?> </td>
                                       
                                        <td valign="top">  <?php if($_SESSION['userid']){?><a href="signout.php">Sign out</a><?php }else{?><a href="signin.php?keepThis=true&TB_iframe=true&height=628&width=750" title="" class="thickbox">Benim Hesabım</a><?php }?> | <a href="register.php?keepThis=true&TB_iframe=true&height=628&width=750" title="" class="thickbox">Yeni Hesap Aç!</a> | <a href="index.php" ><img src="images/turkey.jpg"  /></a> | <a href="../eng/index.php"><img src="images/eng.png"  /></a></td>
                                      </tr>
                                    </table> 				
                             </td>
                          </tr>
