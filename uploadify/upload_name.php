...
if (1) {
	...
	$path=$_FILES['Filedata']['name'];
		...
		if($_FILES['Filedata']['size']>0)
		{
			...
			mysql_query("insert into tbl_hotel_image set hotel_id='$time_id',image='$image1'") or die(mysql_error());
			
//echo "insert into tbl_hotel_image set hotel_id='$time_id',image='$image1'";			
		}
