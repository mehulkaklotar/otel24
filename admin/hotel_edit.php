...
if($del_vdi)
{
	...
	if ($_POST['submitForm'] == "yes")
 	{    
		...
		{
				$email_dup_query=executeQuery("select id from tbl_hotel where hotel_name='$hotel_name' and country='$country' and city='$city' and state='$state' and  local='$local' and village='$village' and zipcode='$zipcode'");
		}
					...
					// echo $sql;
					 executeUpdate($sql);
					  ...
					  $_SESSION['sess_msg']='Hotel updated successfully!';
					   header("Location: hotel_edit.php?id=$id");
			 			exit();
				   }
...
{  	//alert(str);
	...
	xmlhttpPost(strURL, strSubmit, strResultFunc)
	//linkprofile2eng();
	document.getElementById("cityeng").style.display="none";
	document.getElementById("localeng").style.display="none";
	document.getElementById("villageeng").style.display="none";
	document.getElementById("zipcodeeng").style.display="none";
...
{  	
	...
	document.getElementById("cityturkey").style.display="none";
	document.getElementById("localturkey").style.display="none";
	document.getElementById("villageturkey").style.display="none";
	document.getElementById("zipcodeturkey").style.display="none";
...
{  	
	...
	xmlhttpPost(strURL, strSubmit, strResultFunc)
	//s=document.getElementById("cityturkey").value;
	//linkprofilelocal();
	document.getElementById("localturkey").style.display="none";
	document.getElementById("villageturkey").style.display="none";
	document.getElementById("zipcodeturkey").style.display="none";
...
{ // alert(str);
	//str=document.getElementById("cityturkey").value;
	//alert("city onchange");
    url = document.location.href;
	xend = url.lastIndexOf("/") + 1;
	var base_url = url.substring(0, xend);
...
function linkprofilevillage(str)
{  //alert(str);
	//alert("local onchange");
    url = document.location.href;
	xend = url.lastIndexOf("/") + 1;
	var base_url = url.substring(0, xend);
...
$("#fileUploadnamemy1").fileUpload({
		...
		'sizeLimit': 51943040,'scriptData':  {'time_id':'<?=time()?>'},
		onSelect:function()
		{
    ...
    <td height="400" align="center" valign="top">
		<table width="100%"  border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <br>
            <div id="myturkey">
                <form action="hotel_edit.php" method="post" enctype="multipart/form-data"  name="userfrm" onsubmit="return valid_form(this)" >
				...
				<tr  class="oddRow">
					...
					<td align="left" ><select name="user_id" <?php  if($_SESSION['sess_type'] == "Hotel Owners") { echo "disabled='disabled'"; } ?> class="txtfld txt" style="width:250px; " >
...
?>
	...
	<?php } }?>
				  ...
				  </select>&nbsp;<span class="warning"></span>				</tr>
				<tr  class="evenRow">
					<td class="txt" align="right" style="padding-left:80px; "><strong>Mekan Adı</strohng></td>
				  <td align="left" ><input type="text" name="hnt1" class="txtfld txt" id="hnt1" style="width:250px; " value="<?php echo $hotel_name_Turkish; ?>"/>&nbsp;<span class="warning">*</span>				</tr>
				<!--<tr  class="oddRow">
...
?>
	...
	<?php } ?>
			<option value="boutique"<?php if($rate=='boutique'){ echo 'selected';}?> >boutique</option>
					...
					</select>&nbsp;<span class="warning"></span>                    </tr><!-- added by mahi -->
<?php if($place_type == ''){?>                    
...
<?php } ?>
				...
				<tr  class="oddRow">
				  ...
				  <td align="left" ><?php      		 $ofckeditor = new fckeditor('description_turkish');
														...
														$ofckeditor->Create();?>&nbsp;<span class="warning"></span>				</tr>
				<tr  class="evenRow">
...
<a href="hotel_edit.php?id=<?=$_REQUEST['id']?>&del_img=<?=$jack['id']?>" class="orangetxt">Sil</a><br />
								<? }
							} ?>
				...
				<tr  class="oddRow">
					...
					$sharp2=mysql_query("select * from tbl_hotel_video where hotel_id='$id'");
							...
							if($row_sharp2)
							{
								...
								{?>
									Video<?=$j?><br />
<a href="../upload_image/hotel_video/<?=$jack2['video']?>" target="_blank" class="orangetxt">Göster</a>&nbsp;&nbsp;<a href="hotel_edit.php?id=<?=$_REQUEST['id']?>&del_vdi=<?=$jack2['id']?>" class="orangetxt">Sil</a><br />
								<? 
								$j++;
								}
							} ?>
					...
					<?php if($id) { ?><strong style="padding-left:150px;"><a href="javascript:void(0)" onclick="open_win('videoThumbnail.php?id=<?php echo $id; ?>')">Videoya Küçük Resim Ekle</a></strong><?php } ?>					</td>
				...
				<tr  class="evenRow">
				  ...
				  <input type="text" name="prices_turkish" id="prices_turkish" class="txtfld txt" style="width:250px; " value="<?php echo $prices_Turkish; ?>"/>&nbsp;<span class="warning"></span>				</tr>
				<tr class="oddRow">
				...
				<tr  class="oddRow">
				  ...
				  <td align="left" ><input type="text" name="contact_turkish" <?php  if($_SESSION['sess_type'] == "Hotel Owners") { echo "readonly='readonly'"; } ?> id="contact_turkish"class="txtfld txt" style="width:250px; " value="<?php echo $contact_Turkish;?>"/>&nbsp;<span class="warning"></span>				</tr>
				<tr  class="evenRow">
					<td class="txt" align="right" style="padding-left:80px; "><strong>Mekan Adı</strong></td>
				  <td align="left" ><input type="text" name="contact_hotel_turkish" id="contact_hotel_turkish" class="txtfld txt" style="width:250px; " value="<?php echo $contact_hotel_Turkish;?>"/>&nbsp;<span class="warning"></span>				</tr>
				<tr  class="oddRow">
					<td class="txt" align="right" style="padding-left:80px; "><strong>Adres</strong></td>
				  <td align="left" ><textarea <?php  if($_SESSION['sess_type'] == "Hotel Owners") { echo "readonly='readonly'"; } ?> name="address_turkish" id="address_turkish" class="txtfld txt" style="width:250px; height:40px; "><?php echo $address_Turkish;?></textarea>&nbsp;<span class="warning"></span>				</tr>
                <tr  class="evenRow">
					<td class="txt" align="right" style="padding-left:80px; "><strong>Country</strong></td>
					<td align="left" ><select name="country" class="txtfld txt" style="width:250px; " onchange="javascript:linkprofile1eng(this.value);" <?php  if($_SESSION['sess_type'] == "Hotel Owners") { echo " disabled='disabled'"; } ?>>
					<option value="">Please Select Country</option>
<?php //SELECT * FROM `country` WHERE `short_name`, `country`, `country_id`, `status`
$sql_con=mysql_query("SELECT * FROM country where status=1 order by country_Turkish asc");
...
?>
	...
	<?php } }?>					
					</select>&nbsp;<span class="warning"></span></td>				</tr>
                
                    
                <tr  class="oddRow">
					<td class="txt" align="right" style="padding-left:80px; "><strong>State</strong></td>
					<td align="left" id="stateid"><select name="state" <?php  if($_SESSION['sess_type'] == "Hotel Owners") { echo "disabled='disabled'"; } ?> id="stateturkey" class="txtfld txt" style="width:250px" onchange="javascript:linkprofile2(this.value);">
					<option value="">Please Select State</option>
                    <?php //SELECT * FROM `country` WHERE `short_name`, `country`, `country_id`, `status`
$sql_sta=mysql_query("SELECT * FROM state where status=1 order by name_Turkish asc");
...
?>
	...
	<?php } }?>
				...
				<tr  class="evenRow">
					...
					<td align="left" id="cityid">
                    <select name="city" id="cityturkey" <?php  if($_SESSION['sess_type'] == "Hotel Owners") { echo "disabled='disabled'"; } ?> class="txtfld txt" style="width:250px"  onchange="javascript:linkprofilelocal(this.value);" >
					<option value="">Please Select City</option>
                    <?php //SELECT * FROM `country` WHERE `short_name`, `country`, `country_id`, `status`
$sql_city=mysql_query("SELECT * FROM city where status=1 order by city_Turkish asc");
if(@mysql_num_rows($sql_city)>0){
	while($cityline=mysql_fetch_array($sql_city)){
?>
					<option value="<?php echo $cityline['id'];?>"<?php if($line['city']==$cityline['id']){ echo 'selected';}?>><?php echo $cityline['city_Turkish'];?></option>
	<?php } }?>
					</select>                    </td>
				</tr>
                ...
                <!--<tr  class="oddRow">
					...
					<td align="left" id="localid">
                    <select name="local" id="localturkey" class="txtfld txt" style="width:250px "  onchange="javascript:linkprofilevillage(this.value);">
					<option value="">Please Select local</option>
                    <?php //SELECT * FROM `country` WHERE `short_name`, `country`, `country_id`, `status`
$sql_local=mysql_query("SELECT * FROM local where status=1 order by local_Turkish asc");
...
?>
	...
	<?php } }?>
                ...
                <tr  class="evenRow">
                    ...
                    <?php //SELECT * FROM `country` WHERE `short_name`, `country`, `country_id`, `status`
$sql_village=mysql_query("SELECT * FROM village where status=1 order by village_Turkish asc");
...
?>
	...
	<?php } }?>
				...
				<tr  class="oddRow">
					...
					<td align="left" id="zipid"><select name="zipcode" id="zipcodeturkey" class="txtfld txt" style="width:250px">
					<option value="">Please Select Zipcode</option>
                    <?php //SELECT * FROM `country` WHERE `short_name`, `country`, `country_id`, `status`
$sql_zip=mysql_query("SELECT * FROM tbl_zip where status=1 order by zipcode_Turkish asc");
if(@mysql_num_rows($sql_zip)>0){
	while($zipline=mysql_fetch_array($sql_zip)){
?>
					<option value="<?php echo $zipline['id'];?>"<?php if($line['zipcode']==$zipline['id']){ echo 'selected';}?>><?php echo $zipline['zipcode_Turkish'];?></option>
	<?php } }?>
				...
				<tr  class="evenRow">
					<td class="txt" align="right" style="padding-left:80px; "><strong>Latitude</strong></td>
				  <td align="left" ><input type="text" name="latitude" class="txtfld txt" style="width:250px; " value="<?php echo $latitude;?>" <?php  if($_SESSION['sess_type'] == "Hotel Owners") { echo "readonly='readonly'"; } ?>/>&nbsp;<span class="warning"></span>				</tr>
                <tr  class="oddRow">
					<td class="txt" align="right" style="padding-left:80px; "><strong>Longitude</strong></td>
				  <td align="left" ><input type="text" name="longitude" class="txtfld txt" style="width:250px; " value="<?php echo $longitude;?>" <?php  if($_SESSION['sess_type'] == "Hotel Owners") { echo "readonly='readonly'"; } ?>/>&nbsp;<span class="warning"></span>				</tr>  
				<tr  class="evenRow">
					<td class="txt" align="right" style="padding-left:80px; "><strong>Telefon</strong></td>
				  <td align="left" ><input type="text" name="phone" class="txtfld txt" style="width:250px; " value="<?php echo $phone;?>"/>&nbsp;<span class="warning"></span>				</tr>
				<tr  class="oddRow">
					<td class="txt" align="right" style="padding-left:80px; "><strong>Fax</strong></td>
				  <td align="left" ><input type="text" name="fax" class="txtfld txt" style="width:250px; " value="<?php echo $fax;?>"/>&nbsp;<span class="warning"></span>				</tr>
				<tr  class="evenRow">
					<td class="txt" align="right" style="padding-left:80px; "><strong>E-Posta</strong></td>
				  <td align="left" ><input type="text" name="email" class="txtfld txt" style="width:250px; " value="<?php echo $email;?>"/>&nbsp;<span class="warning"></span>				</tr>
               ...
               <div id="myenglish">
              		<form action="hotel_edit.php" method="post" enctype="multipart/form-data"  name="userfrm1" onsubmit="return valid_form(this)" >
			    <input type="hidden" name="submitForm" value="yes">
			    <input type="hidden" name="id" value="<?php echo $id;?>">
                ...
                <tr  class="evenRow">
					...
					$sharp=mysql_query("select * from tbl_hotel_image where hotel_id='$id'");
							...
							if($row_sharp)
							{
								while($jack=mysql_fetch_assoc($sharp))
								{?>
									<img src="../upload_image/hotel_img/thumb/<?=$jack['image']?>" /><br /><a href="hotel_edit.php?id=<?=$_REQUEST['id']?>&del_img=<?=$jack['id']?>" class="orangetxt">Delete</a><br />
								<? }
							} ?>
...
k limited.
				...
				<tr  class="oddRow">
					...
					$sharp2=mysql_query("select * from tbl_hotel_video where hotel_id='$id'");
							...
							if($row_sharp2)
							{
								...
								while($jack2=mysql_fetch_assoc($sharp2))
								{?>
									Video<?=$j?><br /><a href="../upload_image/hotel_video/<?=$jack2['video']?>" target="_blank" class="orangetxt">View</a>&nbsp;&nbsp;<a href="hotel_edit.php?id=<?=$_REQUEST['id']?>&del_vdi=<?=$jack2['id']?>" class="orangetxt">Delete</a><br />
								<? 
								$j++;
								}
							} ?>
				...
				<tr  class="oddRow">
					...
					<td align="left" ><input type="text" name="contact" id="contact" class="txtfld txt" style="width:250px; " value="<?php echo $contact; ?>" <?php  if($_SESSION['sess_type'] == "Hotel Owners") { echo "readonly='readonly'"; } ?>  />&nbsp;<span class="warning"></span>
				</tr>
				<tr  class="evenRow">
					<td class="txt" align="right" style="padding-left:80px; "><strong>Hotel Name</strong></td>
				...
				<tr  class="oddRow">
					...
					<td align="left" ><textarea  name="address" id="address" <?php  if($_SESSION['sess_type'] == "Hotel Owners") { echo "readonly='readonly'"; } ?> class="txtfld txt" style="width:250px; height:40px; "><?php echo $address; ?></textarea>&nbsp;<span class="warning"></span>
				</tr>
				<tr  class="evenRow">
					<td class="txt" align="right" style="padding-left:80px; "><strong>Country</strong></td>
					<td align="left" ><select name="country" class="txtfld txt" style="width:250px; " onchange="javascript:linkprofile1eng(this.value);" <?php  if($_SESSION['sess_type'] == "Hotel Owners") { echo " disabled='disabled'"; } ?>>
...
?>
	...
	<?php } }?>					
                ...
                <tr  class="oddRow">
					<td class="txt" align="right" style="padding-left:80px; "><strong>State</strong></td>
					<td align="left" id="state_id"><select name="state" id="stateeng" class="txtfld txt" style="width:250px" onchange="javascript:linkprofile2eng(this.value);">
					<option value="">Please Select State</option>
                    <?php //SELECT * FROM `country` WHERE `short_name`, `country`, `country_id`, `status`
$sql_sta=mysql_query("SELECT * FROM state where status=1 order by name_English asc");
if(@mysql_num_rows($sql_sta)>0){
	while($staline=mysql_fetch_array($sql_sta)){
?>
...
?>
	...
	<?php } }?>
				...
				<tr  class="oddRow">
					<td class="txt" align="right" style="padding-left:80px; "><strong>Zipcode</strong></td>
					<td align="left" id="zip_id"><select name="zipcode" id="zipcodeeng" class="txtfld txt" style="width:250px">
					<option value="">Please Select Zipcode</option>
                    <?php //SELECT * FROM `country` WHERE `short_name`, `country`, `country_id`, `status`
$sql_zip=mysql_query("SELECT * FROM tbl_zip where status=1 order by zipcode_English asc");
if(@mysql_num_rows($sql_zip)>0){
	while($zipline=mysql_fetch_array($sql_zip)){
?>
	...
	<?php } }?>
                ...
                <tr  class="evenRow">
					<td class="txt" align="right" style="padding-left:80px; "><strong>Latitude</strong></td>
				  <td align="left" ><input type="text" name="latitude" <?php  if($_SESSION['sess_type'] == "Hotel Owners") { echo "readonly='readonly'"; } ?> class="txtfld txt" style="width:250px; " value="<?php echo $latitude;?>"/>&nbsp;<span class="warning"></span>				</tr>
                <tr  class="oddRow">
					<td class="txt" align="right" style="padding-left:80px; "><strong>Longitude</strong></td>
				  <td align="left" ><input type="text" name="longitude" <?php  if($_SESSION['sess_type'] == "Hotel Owners") { echo "readonly='readonly'"; } ?> class="txtfld txt" style="width:250px; " value="<?php echo $longitude;?>"/>&nbsp;<span class="warning"></span>				</tr>  
				<tr  class="evenRow">
