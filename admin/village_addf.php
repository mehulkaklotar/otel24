...
if ($_POST['submitForm'] == "yes") {
  	 	if($id)
		$sql="select * from village where village_English='$village_English' and id<>$id ";
		else
	 	$sql="select * from village where village_English='$village_English' and country_id='$country_id' and state_id='$state_id' and city_id='$city_id' and local_id='$local_id' ";
	    $res=executeQuery($sql);
		if($rows=mysql_num_rows($res))
		{
			 $_SESSION['sess_msg']='This village is already exist';
		}
		else
		{
			if($id==''){
			$sql = "insert into village set village_English='$village_English',village_Turkish='$village_Turkish',country_id='$country_id',status=1,state_id='$state_id',city_id='$city_id',local_id=$local_id";
			
			mysql_query($sql);
			}else{		
			$sql = "update village set village_English='$village_English',village_Turkish='$village_Turkish',country_id='$country_id',state_id='$state_id',city_id='$city_id',local_id=$local_id";
			$sql.=" where id='$id'";
			mysql_query($sql);
			}
			
			header("Location:village_list.php");
			exit();
		}	
		...
		<table width="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="21" align="left" class="txt">
				<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="title">
                    <tr bgcolor="#EDEDED">
                      <td width="76%" height="25"><img src="images/heading_icon.gif" width="16" height="16" hspace="5">Manage Village</td>
                      <td width="24%" align="right"><input name="b1" type="button" class="button" id="b1" value="village Manager" onClick="location.href='village_list.php'">
                      &nbsp;</td>
                    </tr>
              </table>
			</td>
          ...
          <tr>
            <td height="400" align="center" valign="top"><br>
              <form action="village_addf.php" method="post" enctype="multipart/form-data" name="frm" onsubmit="return validate(this)">
              ...
              <input type="hidden" name="local_id1" value="<?=local_id?>" />
			  <table width="68%" border="0" align=center cellpadding="4" cellspacing="0" class="greyBorder">
				...
				<tr class="evenRow">
				  <td width="32%" align="right" class="txt"><strong> Village English :</strong></td>
				  <td width="68%" align="left"><input type="text" name="village_English" style="width:250px; " value="<?php echo $village_English;?>" class="txtfld" />
			      <span class="warning"> *</span></td>
				  </tr>
				<tr class="oddRow">
				  <td width="32%" align="right" class="txt"><strong> Village Turkish:</strong></td>
				  <td width="68%" align="left"><input type="text" name="village_Turkish" style="width:250px; " value="<?php echo $village_Turkish;?>" class="txtfld" />
			      <span class="warning"></span></td>
				  </tr>
				<tr class="evenRow">
