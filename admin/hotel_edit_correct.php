...
$("#fileUploadname3").fileUpload({
		...
		'fileDesc': 'Image Files',
		'fileExt': '*.jpg;*.jpeg;*.png;*.gif',
		'sizeLimit': 512000,'scriptData':  {'time_id':'<?=time()?>'},
		onSelect:function()
		{
...
?>
	...
	<?php } }?>					
                ...
                <tr  class="oddRow">
					...
					<td align="left" id="stateid"><select name="state" id="stateturkey" class="txtfld txt" style="width:250px" onchange="javascript:linkprofile2(this.value);">
...
?>
	...
	<?php } }?>
				...
				<tr  class="evenRow">
                    ...
                    <select name="city" id="cityturkey" class="txtfld txt" style="width:250px"  onchange="javascript:linkprofilelocal(this.value);" >
