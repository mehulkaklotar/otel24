...
<a href="hotel_addf.php?id=<?=$_REQUEST['id']?>&del_img=<?=$jack['id']?>" class="orangetxt">Sil</a><br />
					...
					Bu formatları yükleyin : jpg, gif, png. Her yüklenen belge 5
mb limitlidir.					</td>
				</tr>
				<tr  class="oddRow">
...
<a href="../upload_image/hotel_video/<?=$jack2['video']?>" target="_blank" class="orangetxt">Göster</a>&nbsp;&nbsp;<a href="hotel_addf.php?id=<?=$_REQUEST['id']?>&del_vdi=<?=$jack2['id']?>" class="orangetxt">Sil</a><br />
				...
				<tr  class="oddRow">
				  ...
				  <td align="left" ><input type="text" name="contact_turkish" id="contact_turkish"class="txtfld txt" style="width:250px; " value="<?php echo $contact_Turkish;?>"/>&nbsp;<span class="warning"></span>				</tr>
				<tr  class="evenRow">
				...
				<tr  class="oddRow">
				  ...
				  <td align="left" ><textarea  name="address_turkish" id="address_turkish" class="txtfld txt" style="width:250px; height:40px; "><?php echo $address_Turkish;?></textarea>&nbsp;<span class="warning"></span>				</tr>
                <tr  class="evenRow">
					<td class="txt" align="right" style="padding-left:80px; "><strong>Country</strong></td>
					<td align="left">
                    <select name="country" class="txtfld txt" style="width:250px;" onchange="javascript:linkprofile1(this.value);">
	...
	<?php } }?>
                ...
                <tr  class="oddRow">
					<td class="txt" align="right" style="padding-left:80px; "><strong></strong></td>
					<td align="left" id="stateid">
                    <select name="state" id="stateturkey" class="txtfld txt" style="display:none;" onchange="javascript:linkprofile2(this.value);">
	...
	<?php } }?>
				...
				<tr  class="evenRow">
                    ...
                    <select name="city" id="cityturkey" class="txtfld txt" style="display:none;" onchange="javascript:linkprofilelocal(this.value)">
	...
	<?php } }?>
               ...
               <!-- <tr  class="oddRow">
					...
					<td align="left" id="localid">
                    	<select name="local" id="localturkey" class="txtfld txt" style="display:none;"  onchange="javascript:linkprofilevillage(this.value)">
	...
	<?php } }?>
                ...
                <tr  class="evenRow">
					<td class="txt" align="right" style="padding-left:80px; "><strong></strong></td>
					<td align="left" id="villageid"><select name="village" id="villageturkey" class="txtfld txt" style="display:none;" onchange="javascript:linkprofile3(this.value)">
...
?>
	...
	<?php } }?>
				...
				<tr  class="oddRow">
					<td class="txt" align="right" style="padding-left:80px; "><strong></strong></td>
					<td align="left" id="zipid"><select name="zipcode" id="zipcodeturkey" class="txtfld txt" style="display:none;">
	...
	<?php } }?>
			   ...
			   ?> 
				...
				<tr  class="evenRow">
				  ...
				  <td align="left" ><input type="text" name="latitude" class="txtfld txt" style="width:250px; " value="<?php echo $latitude;?>"/>&nbsp;<span class="warning"></span>				</tr>
                <tr  class="oddRow">
					<td class="txt" align="right" style="padding-left:80px; "><strong>Longitude</strong></td>
				  <td align="left" ><input type="text" name="longitude" class="txtfld txt" style="width:250px; " value="<?php echo $longitude;?>"/>&nbsp;<span class="warning"></span>				</tr>  
				<tr  class="evenRow">
...
<?php } ?>
                ...
                <tr  class="evenRow">
					...
					<br />
					<input class="upload_button" type="button" onClick="javascript:$('#fileUploadnamemy1').fileUploadStart();" name="submit1" value="Upload">&nbsp;<br />
					You can select multiple Image File. jpg, gif, png only. Per item 5
mb limited.
					</td>
				</tr>
				<tr  class="oddRow">
...
?>
	...
	<?php } }?>					
                ...
                <tr  class="oddRow">
					<td class="txt" align="right" style="padding-left:80px; "><strong></strong></td>
					<td align="left" id="state_id"><select name="state" id="stateeng" class="txtfld txt" style="display:none" onchange="javascript:linkprofile2eng(this.value);">
					<option value="">Please Select State</option>
                    <?php //SELECT * FROM `country` WHERE `short_name`, `country`, `country_id`, `status`
...
?>
	...
	<?php } }?>
				...
				<tr  class="evenRow">
                    ...
                    <select name="city" id="cityeng" class="txtfld txt" style="display:none"  onchange="javascript:linkprofilelocaleng(this.value)" >
					<option value="">Please Select City</option>
                    <?php //SELECT * FROM `country` WHERE `short_name`, `country`, `country_id`, `status`
...
?>
	...
	<?php } }?>
                ...
                <!--<tr  class="oddRow">
                    ...
                    <select name="local" id="localeng" class="txtfld txt" style="display:none "  onchange="javascript:linkprofilevillageeng(this.value)">
					<option value="">Please Select local</option>
                    <?php //SELECT * FROM `country` WHERE `short_name`, `country`, `country_id`, `status`
...
?>
	...
	<?php } }?>
                ...
                <tr  class="evenRow">
                    ...
                    <select name="village" id="villageeng" class="txtfld txt" style="display:none "  onchange="javascript:linkprofile3eng(this.value)"  >
					<option value="">Please Select Village</option>
                    <?php //SELECT * FROM `country` WHERE `short_name`, `country`, `country_id`, `status`
...
?>
	...
	<?php } }?>
				...
				<tr  class="oddRow">
					<td class="txt" align="right" style="padding-left:80px; "><strong></strong></td>
					<td align="left" id="zip_id"><select name="zipcode" id="zipcodeeng" class="txtfld txt" style="display:none">
					<option value="">Please Select Zipcode</option>
                    <?php //SELECT * FROM `country` WHERE `short_name`, `country`, `country_id`, `status`
