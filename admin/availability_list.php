          ...
          <tr>
            ...
            <td height="21" align="left" class="txt">
				...
				<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="title">
                    ...
                    Akıllı Arama : 
                        <input type="text" id="txtsearch" name="txtsearch" value="<?php echo $_REQUEST['txtsearch'];?>" size="20" class="input" /> <input  type="submit" name="search" value="Ara"  class="button" />&nbsp;<input type="button"  value="Hepsini Göster"  onclick="javascript:location.href='hotel_list.php'" class="button" /><div id="container1" style="width:250px;"></div>
					...
					?>
                        <tr class="<?php print $className?>">
                         <!-- <td align="center" class="txt" ><?php //echo $i?></td>-->
                          ...
                          <td valign="middle" class="txt" align="center"><a href="availability_addf.php?id=<?php print $line[0]?>" class="orangetxt">Oda Satışları</a></td>
                          ...
                          <td colspan="100%"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                <td width="67%" align="right">
                                    ...
                                    <?php if($_SESSION['sess_type']=='Super Admin'  || $_SESSION['sess_type']=='Admin' || $_SESSION['sess_type']=='Hotel Owners'){?><!--<input type="submit" name="submit" value="Delete" class="button" onclick="return del_prompt(this.form,this.value,'hotel_del.php')" />--><? }?>
                                    <br />
                                </td>
                              </tr>
                          </table></td>
                        ...
                        <tr align="center" class="oddRow">
                          <td colspan="10" class="warning">Üzgünüz, ilgili kayıt bulanamadı.</td>
                        </tr>
                        <?php }?>
                      </table>
				    </form>
