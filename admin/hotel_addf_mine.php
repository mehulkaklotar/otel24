...
<?php if($place_type == ''){?>                    
                ...
                <tr  class="evenRow">
                    ...
                    <option onclick="javascript:showDivArea('area10')" value="Hotel">Hotel</option>
...
<?php }else{?>                
	<tr  class="evenRow">
                    ...
                    <option onclick="javascript:showDivArea('area10')" <?php if($place_type == 'Hotel'){ echo 'selected'; }?> value="Hotel">Hotel</option>
...
k limited.
				...
				<tr  class="evenRow">
					...
					<td align="left" ><?php /* $ofckeditor = new fckeditor('prices');
														...
														$ofckeditor->Create();
											*/											
											?><strong>From &euro;</strong><input type="text" name="prices" class="txtfld txt" style="width:250px; " value="<?php echo stripslashes($prices);?>"/>&nbsp;<span class="warning"></span>
				</tr>
				<tr class="oddRow">
