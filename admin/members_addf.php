...
{    
	 ...
	 {
	    $_SESSION['sess_msg']='Member Id / Email  already exist!';
	    header("Location: members_addf.php");
		exit();
	 }else {
	 	if($id==''){
	    ...
	    $_SESSION['sess_msg']='Memberupdated successfully!';
	 	}	  
    ...
    <td height="400" align="center" valign="top">
		<table width="100%"  border="0" cellpadding="0" cellspacing="0">
            ...
            <td height="21" align="left" class="txt">
				<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="title">
                    <tr bgcolor="#EDEDED">
                      ...
                      <td width="24%" align="right"><input name="b1" type="button" class="button" id="b1" value="MemberManager" onClick="location.href='members_list.php'">
                      &nbsp;</td>
                    </tr>
              </table>
			</td>
          ...
          <tr>
            <td height="400" align="center" valign="top">
			<br />
              <form action="members_addf.php" method="post" enctype="multipart/form-data" name="frm"    onsubmit="return validate_form(this)">
			  ...
			  <input type="hidden" name="id" class="txtfld txt" value="<?php echo $id;?>">
				...
				<tr class="evenRow">
					<td  align="right" width="35%" class="txt"><strong >MemberId:  </strong></td>
				...
				<tr class="oddRow">
				  <td class="txt" align="right"><strong>Password:</strong></td>
				 ...
				 ?> 
				<tr class="evenRow">
					<td  align="right" width="35%" class="txt"><strong >Full Name:  </strong></td>
				  <td align="left" width="65%"><input type="text" name="full_name" style="width:250px;" value="<?php echo $full_name;?>" class="txtfld txt" />
                    <span class="txt"><span class="warning">*</span></span></td>
				</tr>
				<tr class="oddRow">
					<td  align="right" width="35%" class="txt"><strong >Email:  </strong></td>
				...
				<tr class="oddRow">
					<td  align="right" width="35%" class="txt"><strong >MemberType:  </strong></td>
				  <td align="left" width="65%"><select name="user_type" class="txtfld txt"  style="width:250px;">
												...
												<option value="Hotel Owners"<?php if($user_type=='Hotel Owners'){ echo 'selected';} ?>>Hotel Owners</option>
												<option value="Hotel Owners"<?php if($user_type=='Member'){ echo 'selected';} ?>>Member</option>
                                                </select>
                    <span class="txt"><span class="warning">*</span></span></td>
				</tr>
				<TR class="evenRow">
