	...
	if($id){
			...
			if(mysql_num_rows($email_dup_query)>0){
				 $_SESSION['sess_msg']='This Hotel already exist';
					 ...
					 $sql = "update tbl_hotel set hotel_name_Turkish='$hotel_name_Turkish',description_Turkish='".addslashes($description_Turkish)."',activities_Turkish='".addslashes($activities_Turkish)."',services_Turkish='".addslashes($services_Turkish)."',generals_Turkish='".addslashes($generals_Turkish)."',rooms_Turkish='".addslashes($rooms_Turkish)."',prices_Turkish='".addslashes($prices_Turkish)."',historical_Turkish='".addslashes($historical_Turkish)."',entertainment_Turkish='".addslashes($entertainment_Turkish)."',contact_Turkish='$contact_Turkish',contact_hotel_Turkish='$contact_hotel_Turkish',address_Turkish='$address_Turkish'";
            ...
            <td height="21" align="left" class="txt">
				<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="title">
                    <tr>
                      ...
                      <td width="50%" align="right"><?php if(isset($_GET['id'])){?><a href="change_image.php?id=<?php echo $_GET['id'];?>"><input name="b1" type="button" class="button" id="b1" value="Change Image"></a><a href="change_video.php?id=<?php echo $_GET['id'];?>"><input name="b1" type="button" class="button" id="b1" value="Change Video"></a><?php }?><input name="b1" type="button" class="button" id="b1" value="Manage Place" onClick="location.href='hotel_list.php'">
                      &nbsp;</td>
                    </tr>
              </table>
			</td>
          ...
          <tr>
            <td height="400" align="center" valign="top"><br>
                ...
                <tr  class="evenRow">
					...
					<td align="left" ><?php echo $place_type; ?> 
                    ...
                    <div id="area10">
                    	<table border="0" width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr class="evenRow">
                            	<td>Decor: </td>
                                <td><?php echo $decor_p;?></td>
                            </tr>
                            <tr class="oddRow">
                            	<td>Services: </td>
                                <td><?php echo $service_p;?></td>
                            </tr>
                            <tr class="evenRow">
                            	<td>Cost: </td>
                                <td width="50px"><?php echo $cost_p;?></td>
                            </tr>    
                        </table>
                    </div>
				</tr>
				...
				<tr  class="oddRow">
					...
					<td align="left" ><?php  /*
														$ofckeditor = new fckeditor('prices_Turkish');
														$ofckeditor->BasePath = 'FCKeditor/';
														$ofckeditor->Width  = '100%' ;
														$ofckeditor->Height = '300' ;
														$ofckeditor->Value = stripslashes($prices_Turkish);
														$ofckeditor->Create();
											*/
											?><strong>En düşük &euro;</strong><input type="text" name="prices_Turkish" class="txtfld txt" style="width:250px; " value="<?php echo stripslashes($prices_Turkish);?>"/>&nbsp;<span class="warning"></span>
				</tr>
				<tr class="evenRow">
