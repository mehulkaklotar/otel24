            ...
            <td height="21" align="left" class="txt">
				<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="title">
                    <tr bgcolor="#EDEDED">
                      ...
                      <td width="24%" align="right"><input name="b1" type="button" class="button" id="b1" value="User Manager" onClick="location.href='user_list.php'">
                      &nbsp;</td>
                    </tr>
              </table>
			</td>
          ...
          <tr>
			...
			<br />
			  ...
			  <input type="hidden" name="id" class="txtfld txt" value="<?php echo $id;?>">
				...
				<tr class="evenRow">
					<td  align="right" width="35%" class="txt"><strong >User Id:  </strong></td>
				...
				<tr class="oddRow">
					<td  align="right" width="35%" class="txt"><strong >User Type:  </strong></td>
				  <td align="left" width="65%"><select name="user_type" class="txtfld txt"  style="width:250px;">
				  								<option value="">--Select User Type--</option>
												<option value="admin"<?php if($user_type=='admin'){ echo 'selected';} ?>>Super Admin</option>
												<option value="editors"<?php if($user_type=='editors'){ echo 'selected';} ?>>Editors</option>
												<option value="owners"<?php if($user_type=='owners'){ echo 'selected';} ?>>Hotel Owners</option>
												</select>
                    <span class="txt"><span class="warning">*</span></span></td>
				</tr>
				<TR class="evenRow">
