  ...
  <tr>
   ...
   <td width="1" bgcolor="#398FA8"><img src="images/spacer.gif" width="1" height="1" /></td>
          ...
          <tr>
            <td height="21" align="left" class="txt">
				<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="title">
                    <tr bgcolor="#EDEDED">
                      <td width="70%" height="25"><img src="images/heading_icon.gif" width="16" height="16" hspace="5">Manage Local</td>
                      <td width="30%" align="right">
					   <select name="keycountry" class="txtfld txt" style="width:150px; " onchange="javascript:location.href='local_list.php?keycountry='+this.value;">
	...
	<?php } }?>
					  ...
					  &nbsp;&nbsp;<input name="b1" type="button" class="button" id="b1" value="Add Local" onClick="location.href='local_addf.php'">
          ...
          <tr>
            <td height="21" align="left" class="txt">
				...
				<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="title">
                    ...
                    Search: <input type="text" id="txtsearch" name="txtsearch" value="<?php echo $_REQUEST['txtsearch'];?>" size="20" class="input" /> <input  type="submit" name="search" value="Search"  class="button" />&nbsp;<input type="button"  value="Show All"  onclick="javascript:location.href='local_list.php'" class="button" /><div id="container1" style="width:250px;"></div>
...
{
	$sql=mysql_query("select local.*,city.city_English,state.name_English,country.country_English from local,city,state,country where local.city_id=city.id and local.state_id=state.id and local.country_id=country.country_id $where and (local_English like '%".$_REQUEST['txtsearch']."%' or local_Turkish like '%".$_REQUEST['txtsearch']."%') order by $order_by $order_by2 limit $start,$pagesize");

	$reccnt=mysql_num_rows(executeQuery("select local.*,city.city_English,state.name_English,country.country_English from local,city,state,country where local.city_id=city.id and local.state_id=state.id and local.country_id=country.country_id $where and (local_English like '%".$_REQUEST['txtsearch']."%' or local_Turkish like '%".$_REQUEST['txtsearch']."%')"));
}
else
{

$sql=mysql_query("select local.*,city.city_English,state.name_English,country.country_English from local,city,state,country where local.city_id=city.id and local.state_id=state.id and local.country_id=country.country_id $where order by $order_by $order_by2 limit $start,$pagesize");



$reccnt=mysql_num_rows(executeQuery("select local.*,city.city_English,state.name_English,country.country_English from local,city,state,country where local.city_id=city.id and local.state_id=state.id and local.country_id=country.country_id $where"));
                ...
                <tr>
				  ...
				  <?php if($reccnt>0){?>
					...
					<TD width="10%" align="center"><strong class="bigWhite">S.No. </strong></TD>
					  <TD width="21%" align="center"><span class="bigWhite"><strong>Local(English)</strong></span><strong> <?php echo sort_arrows('local_English')?></strong></TD>
					  <TD width="21%" align="center"><span class="bigWhite"><strong>Local(Turkish)</strong></span><strong> <?php echo sort_arrows('local_Turkish')?></strong></TD>
					...
					<TD align="center" class="txt" ><?php echo $i?></TD> 
					 ...
					 <?php echo ucwords($line['local_English']);?>
					 &nbsp;</TD>
					 <TD align="center" class="txt" >
					 <?php echo ucwords($line['local_Turkish']);?>
					 &nbsp;</TD>                     
                     <?php 
					 ...
					 <td valign="middle" align="center"><a href="local_addf.php?id=<?php print $line['id']?>" class="orangetxt">Edit</a></td>
