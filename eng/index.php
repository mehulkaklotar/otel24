...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td>
                	<ul class="tabs">
    <li><a href="#tab1">Smart Search</a></li>
    <li><a href="#tab2">By Map</a></li>
</ul>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        ...
                                        <table align="center" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            <td valign="top" ><input type="text" id="searchbar" name="searchbar" value="Please enter 'City Name' or 'Hotel Name' before search." class="searchbar head2 searchbara keyboardInput input" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;" onkeypress="searchenter(event);"/>
       ...
       <?php include("bymap.php");?>
              ...
              <tr>
                <td style="padding:10px;">
                	<table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td class="editor">TOP 25 TRUSTED HOTELS</td>
