...
<?php
	if(isset($_POST['book']))
	{
		...
		if(mysql_num_rows($aval_res)>0)
		{
			...
			$sqlselect="select hotel_name from tbl_hotel where id='".$_POST['id']."'";
...
//			mysql_query($sqlupdate);
	...
	// To send HTML mail, the Content-type header must be set			
			...
			$msg="Hello '".$rowselect['uid']."',<br /> Customer ".$_POST['custname']." has successfully booked your ".$rowselect['hotel_name'].". Hotel. The Details Regarding which are as follows : <br><br> Phone: ".$_POST['custphone']."<br>Email-ID: ".$_POST['custemail']."<br>Check-In Date: ".$_POST['custcheckin']."<br>Check-Out Date: ".$_POST['custcheckout']."<br>Adults: ".$_POST['custadults']."<br>Children: ".$_POST['custchildren']."<br>Room Type: ".$_POST['custroomtype']." <br><br>Regards,<br>OTEL24";
			$to=$rowselect['email'];
			$from="noreply@otel24.com";
